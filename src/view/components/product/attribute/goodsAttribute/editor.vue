...
export default {
   ...
   data(){
    ...
    created:function(){
        this.handelGetAttributeInfo({id:this.id}).then(data => {
    ...
    methods:{
      ...mapActions([
          "handelGetAttributeInfo",
          "handelSaveEditoryAttributeInfo"
            ]),
      gotoback() {
        ...
        handleSubmit(name){
            this.$refs[name].validate((valid) => {
                    if (valid) {
                        ...
                        let that = this;
                        this.handelSaveEditoryAttributeInfo(this.formValidate).then(res => {
